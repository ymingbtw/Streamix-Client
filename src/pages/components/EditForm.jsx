...
export default function EditForm({
  ...
  return (
    <div
      ref={formDialog}
      className="backdrop-blur-md overflow-scroll flex flex-col gap-4 h-[75vh] hide-scrollbar left-[50%] translate-x-[-50%] z-30 absolute text-white bg-[#141414] rounded-xl shadow-lg w-[75vw] p-[1rem]"
    >
        ...
        <button
          onClick={async () => {
            const res = await axios.put(
              "http://api.ecnet.website/api/movies",
              {
                ...movieForm,
