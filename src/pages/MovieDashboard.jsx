...
export default function MovieDashboard() {
  ...
  const queryMovies = debounce(async function () {
    ...
    const res = await axios.get(
      `http://api.ecnet.website/api/movies?genre=${selectedGenre}&title=${query}`,
      {
        headers: {
  ...
  useEffect(() => {
    async function fetchGenres() {
      const res = await axios.get("http://api.ecnet.website/api/genres/main", {
        headers: {
          Authorization: `Bearer ${token}`,
        },
        withCredentials: true,
    ...
    async function initMovies() {
      setLoading(true);
      const res = await axios.get(`http://api.ecnet.website/api/movies`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
        withCredentials: true,
